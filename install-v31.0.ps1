...
Write-Host ""
Write-Host "Next: git add -A; git commit -m 'v31.0 rapid motor model, export privacy, opt-in drafts, consolidated UI'; git push origin main"
