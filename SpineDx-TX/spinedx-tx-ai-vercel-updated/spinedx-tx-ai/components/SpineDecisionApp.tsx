      ...
      <div className="layout">
        ...
        <aside className="results" ref={resultsRef} aria-live="polite">
          ...
          {result && <>
            ...
            <div className="score-card"><div className="score-heading"><div><span>Clinical–imaging concordance</span><strong>{result.concordanceScore}</strong><small>/100</small></div><b className={`label ${result.concordanceLabel}`}>{result.concordanceLabel}</b></div><div className="meter"><i style={{ width: `${result.concordanceScore}%` }} /></div><small>Structured support score—not a validated probability or surgical indication.</small></div>
